...
- **Be welcoming and inclusive.** Make an effort to include people who differ from you.
- **Be respectful.** Disagreement is fine; disrespect is not. A community where people feel uncomfortable or threatened is not a productive one.
- **Be thoughtful about the space you take up.** Share airtime in discussions. Step back when others are trying to contribute.
- **Respect people's boundaries.** Ask before photographing or recording someone. Respect a "no" or "not right now" without pushing back.
- **Look out for each other.** If you see someone being harassed or excluded, consider intervening or finding an organizer.
...
- Harassing photography or recording—including photographing or recording someone who has asked not to be
...
This Code of Conduct draws from the [UC OSPO Network Code of Conduct](https://github.com/UC-OSPO-Network/ucospo.net/blob/main/CODE_OF_CONDUCT.md) (adapted from [Contributor Covenant 3.0](https://www.contributor-covenant.org/version/3/0/)) and the [PyBay Code of Conduct](https://pybay.org/code-of-conduct/).
