---
title: 'Open Analytics Control Tower (OACT): A "Right to Replicate" Prototype for Infrastructure Risk'
---
...
```{image} ./speaker-headshots/laisi-ma.jpeg
:alt: Laisi Ma
:class: speaker-bio-img
```
...
```{image} ./speaker-headshots/hao-he.jpg
:alt: Hao He
:class: speaker-bio-img
```
...
### Yuan-Jiun (David) Sung | Independent Researcher (Principal Investigator, remote) | [OACT Project Hub](https://resilient-supply-chain.github.io/open-supply-chain-control-tower/)
