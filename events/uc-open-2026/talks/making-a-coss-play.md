...
```{image} ./speaker-headshots/karla-padilla.jpg
:alt: Karla Padilla
...
```{image} ./speaker-headshots/heather-meeker.jpg
:alt: Heather Meeker
:class: speaker-bio-img
```
...
Dirk Riehle is a professor of computer science at FAU Erlangen. They are also the CEO of Bayave GmbH, a training and consulting firm. Their work helps companies succeed in and through software, with a specialization in open source, inner source, and product strategy. Before joining academia, Prof. Riehle led the open source research group at SAP Labs in Palo Alto, California (Silicon Valley). They also worked for software startups and large corporations in Boston, MA and Zurich, Switzerland, as a software developer, architect, and engineering manager. Riehle holds a Ph.D. in computer science from ETH Zurich and an M.B.A. from Stanford Graduate School of Business. They welcome email at [dirk@riehle.org](mailto:dirk@riehle.org), blog at [dirkriehle.com](https://dirkriehle.com), and tweet as [@dirkriehle](https://twitter.com/dirkriehle).
