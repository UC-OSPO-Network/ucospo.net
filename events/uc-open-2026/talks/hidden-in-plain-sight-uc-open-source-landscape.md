...
To address this gap, the UC OSPO Network is developing the UC Open Repository Browser (UC ORB), an interactive explorer that maps and visualizes UC's open source activity. It surfaces key signals such as license usage, presence of community health files (e.g., README, LICENSE, CONTRIBUTING, CODE_OF_CONDUCT), contributor patterns, and repository metadata to provide a system wide view of how open source is practiced across UC campuses.
