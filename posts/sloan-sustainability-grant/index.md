...
The award builds on earlier Sloan Foundation investment in open source at UC. The Foundation funded the launch of the OSPO at UC Santa Cruz in 2022, and in 2024 a $1.85 million grant established the UC OSPO Network, extending the model to partners at Berkeley, Davis, Los Angeles, San Diego, and Santa Barbara (see the [2024 UCSC news release](https://news.ucsc.edu/2024/04/uc-ospo-network/)). Now in its third year, the Network has stood up local and all-network meetups, consultations, office hours, instruction, and partnerships with other units across its campuses. Most importantly, the Network has expanded from the original six campuses to include two additional campuses: UCSF and UC Law SF (formerly known as UC Hastings).
