...
- Each Member Organization should have a high degree of autonomy.
- Each Working Group should have a high degree of autonomy.
- Regardless of professional title, all participants meet within the Network as peers. We rely on a combination of top-down and bottom-up decision-making, in keeping with the values of community-driven open source.
...
Each Working Group decides on their own aim, domain, membership criteria, and decision-making procedures. Working Groups may consider adopting the existing [ORB Working Group's decision-making procedure](https://github.com/UC-OSPO-Network/orb-community/blob/main/GOVERNANCE.md) as a starting point.
...
- Briefs the Alignment Group on their progress, goals, and challenges, including progress toward sponsored project deliverables.

Decides:

- Scope of authority is determined by the Working Group's domain.

#### Composition

- Membership criteria are determined by the Working Group during the provisional phase. As such, Working Groups decide whether their group is open to the public, only UC affiliates, etc., subject to approval by the Stewardship Group.
- **Note that each Member Organization must commit to participating in at least one Working Group.**
- Each Working Group must designate a chair who attends Alignment Group meetings. Other roles, such as facilitator, secretary, or technical lead may be assigned at the discretion of the Working Group.
...
- Disputes between working groups.
- The formation or dissolution of WGs.
- Changes to the aims or domains of WGs.

Briefs Stewardship Group on:

- Network health and morale.
- Notable changes in Working Group composition, aims, or domains.
- Changes to operational policies and procedures.

Decides:

- Operational policies that affect more than one working group, such as onboarding procedures, internal communications, Code of Conduct, and safety protocols.
- Disbursing and managing funds within the Stewardship Group-approved operational budget.
...
- Advises Alignment Group on legal compliance and risk management.
- Advises Alignment Group on Working Group aims and domains.

Briefs:

- Briefs Alignment Group delegates on Network finances and development efforts.

Decides:

- Incorporation and termination of Member Organization memberships.
- Member Organization membership criteria.
- Long-term strategic plans.
- Overall network budget, including personnel.
- Has the power to discontinue Network activities that threaten the legal, institutional, or financial integrity of the Network.
- Termination of Working Groups whose mission is not aligned with that of the Network.

#### Composition

Alignment group delegates:

- Two Alignment Group delegates must attend at least part of each Stewardship Group meeting. These delegates should be full-time Network staff if such staff are available and willing to attend.

  Member Organization representation:

- Each Member Organization must provide one delegate to the Stewardship Group. Member Organizations may choose to designate a back-up delegate who can assume the delegate's duties when the delegate is unavailable.
- The choice of delegate(s) is ultimately up to the Member Organization; the Stewardship Group can provide advice on their expectations for a suitable delegate.
- For a prospective Member Organization to join the Network/Stewardship Group, Member Organization delegates must provide the written approval of a Sponsor (described in Sponsors section).

Chair and vice chair:

- The Stewardship Group must designate a Chair responsible for ensuring the group fulfills its obligations to the Network, including scheduling regular meetings, facilitating timely decision-making, and managing prompt responses to inquiries. The Chair serves a standard two-year term, renewable for a maximum of three consecutive terms.
- The Stewardship Group must also designate a Vice Chair to support the Chair and assume their duties when the Chair is unavailable. To ensure continuity of leadership, the Vice Chair will automatically assume the role of Chair upon the current Chair's resignation or the conclusion of their term.
- In exceptional circumstances where a critical decision must be made immediately and the full Stewardship Group cannot be convened, the Chair is authorized to make that decision on behalf of the group. Any emergency decisions must be promptly disclosed to the Stewardship Group for review.
- The Stewardship Group may remove a Chair from leadership prior to the end of their term by a two-thirds vote by the full Stewardship Group membership. Justifiable reasons for removal include but are not limited to: abuse of emergency executive authority, failure to adequately perform assigned duties, or failure to adhere to the Network's Code of Conduct.
...
- Expects to receive additional services from the Network beyond our standard offerings, OR
- Requests a letter of support from the Network.
...
- Regular updates to the Stewardship Group (e.g. every 6 months), AND
- Participation in at least one Working Group.
