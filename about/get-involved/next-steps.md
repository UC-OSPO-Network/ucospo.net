...
You don't have to do everything at once. Here's a rough sequence that's worked for campuses standing up an OSPO—skip or reorder whatever doesn't fit.
...
- **Open the Sponsor conversation:** identifying an [executive Sponsor](./what-it-means.md) is the slowest step, so start it early.
...
The Network runs on a few simple channels—keep these handy:
...
Anytime—really. None of this is meant to be solved alone; the Network exists so you don't have to. Reach out to **Laura Langdon** (community manager) or **Stephanie Lieggi** (chair), or just ask in Slack. We're glad you're here.
